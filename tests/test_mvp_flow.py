...
class MvpFlowTests(unittest.TestCase):
    ...
    def test_tally_client_accepts_xml_responses_and_strips_source(self) -> None:
        ...
        self.assertLess(sent["data"].index("<LEDGERNAME>Cash</LEDGERNAME>"), sent["data"].index("<LEDGERNAME>CGST</LEDGERNAME>"))
        self.assertIn("<GSTRATEDUTYHEAD>CGST</GSTRATEDUTYHEAD>", sent["data"])
        self.assertIn("<GSTRATE>9.00</GSTRATE>", sent["data"])
        self.assertIn("<GSTRATEDUTYHEAD>SGST/UTGST</GSTRATEDUTYHEAD>", sent["data"])
        self.assertIn("<GSTRATEDUTYHEAD>IGST</GSTRATEDUTYHEAD>", sent["data"])
        self.assertIn("<GSTRATE>0.00</GSTRATE>", sent["data"])
